...
<link href="${pageContext.request.contextPath}/resources/css/interior_consult_css/cssHeader.css" rel="stylesheet" type="text/css">
	...
	<link href="${pageContext.request.contextPath}/resources/css/interior_consult_css/remodeling_price.css" rel="stylesheet" type="text/css"/>
        <div class="container">
            <article class="mx-auto" style="width: 80%; background-color: white; display: flex;">
                <section style="display: inline-block; width: 15%;" class="border">
                    <div style="width: 100%;" class="text-right pr-2">
                        <ul class="remodeling_price_quote_main_radio_btn">
                            <li><button class="btn remodeling_price_aside_jsonci_class" value="all" onclick="js:remodeling_price_aside_btn('all')" style="color: #ca5c0d; font-weight: bold;">종합</button></li>
                            <li><button class="btn remodeling_price_aside_jsonci_class" value="papering" onclick="js:remodeling_price_aside_btn('papering')">도배</button></li>
                            <li><button class="btn remodeling_price_aside_jsonci_class" value="waiting" onclick="js:remodeling_price_aside_btn('waiting')">대기실</button></li>
                            <li><button class="btn remodeling_price_aside_jsonci_class" value="treatment" onclick="js:remodeling_price_aside_btn('treatment')">진료실</button></li>
                            <li><button class="btn remodeling_price_aside_jsonci_class" value="disinfection" onclick="js:remodeling_price_aside_btn('disinfection')">소독실</button></li>
                        </ul> 
                    </div>
                </section>
