...
<div id="model_dental_wrap" class="d-flex flex-column" style="background-color: #faf9f6; font-family: 'MinSans-Regular';">
        ...
        <div id="model_dental_content" class="text-center">
            <div>
                ...
                <p class="mb-5">[입구]</p>
                <p class="mb-5 model_dental_content_p">치과 입구 모습입니다. 입구는 블랙톤으로 무게감있게 연출했습니다.</p>
            </div>
            <div>
                ...
                <p class="mb-5 model_dental_content_p">치과 내부 모습입니다. 화이트톤을 기반으로 청결한 이미지를 중점적으로 연출했습니다</p>
            </div>
            <div id="model_dental_waiting_room">
                ...
                <p class="mb-5">[진료실]</p>
                <p class="mb-5 model_dental_content_p">진료실 내부 모습입니다. 화이트와 블랙의 대비감을 이용해 더 널어 보이게 연출했습니다.</p>
            </div>
            <div id="model_dental_X-ray_room">
                ...
                <p class="mb-5 model_dental_content_p">X-ray촬영실은 블랙으로 포인트를 주었습니다.</p>
            </div>
            <div id="model_dental_makeup_corner">
                ...
                <p>[특진실]</p>
                <p class="mb-5 model_dental_content_p">VIP를 위한 특진실 내부 모습입니다. 그레이톤 벽에 치과와 관련된 그래픽을 넣어 포인트를 주었습니다.</p>
            </div>
            <div id="model_dental_doctor_room">
                ...
                <p>[상담실]</p>
                <p class="mb-5 model_dental_content_p">상담실입니다. 벽을 유리로 시공해 시각적으로 더 넓어 보이는 느낌을 주었습니다.</p>
            </div>
...
<!--     <style>
    	...
    	.model_dental_content_img{ width: 60%; }
    	.model_dental_content_p{ width: 60%; margin: 0 auto; }
    </style> -->
