...
<div id="model_dental_wrap" class="d-flex flex-column" style="background-color: #faf9f6; font-family: 'MinSans-Regular';">
        <div id="model_dental_main_img" class="text-center"><img class="vw-100" style="height: 450px;" src="/springframework-mini-project/portfolio_dental/display?fileName=${interiorDetail2.imMainImg}"/></div>
