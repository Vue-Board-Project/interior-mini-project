...
<div class="d-flex pt-5" style="background-color: #faf9f6; height: 297rem;  font-family: 'MinSans-Regular';">
	<%@ include file="/WEB-INF/views/model_dental/model_dental_floating_menu.jsp" %>
        <div class="d-flex flex-column vw-100">
            <div id="model_dental_wrap" style="border: 1px solid #b3b39f; margin: 0 auto; width: 50%;">
                <%@ include file="/WEB-INF/views/model_dental/model_dental_detail_slide.jsp" %>
                ...
                <div id="model_dental_content" class="text-center">
                    <div>
                        <div class="mb-5"><img src="${pageContext.request.contextPath}/resources/model_dental_images/photos/black_1.PNG" style="width: 80%;"/></div>
                        <p class="mb-5">[입구]</p>
                        <p class="mb-5" style="width: 80%; margin: 0 auto;">치과 입구 모습입니다.
                            입구는 블랙톤으로 무게감있게 연출했습니다.</p>
                    </div>
                    <div>
                        <div class="mb-5"><img src="${pageContext.request.contextPath}/resources/model_dental_images/photos/black_2.PNG" style="width: 80%;"/></div>
                    ...
                    <div id="model_dental_waiting_room">
                        <div class="mb-5"><img src="${pageContext.request.contextPath}/resources/model_dental_images/photos/black_3.PNG" style="width: 80%;"/></div>
                        <div class="mb-5"><img src="${pageContext.request.contextPath}/resources/model_dental_images/photos/black_6.PNG" style="width: 80%;"/></div>
                        <p class="mb-5">[진료실]</p>
                        <p class="mb-5" style="width: 80%; margin: 0 auto;">진료실 내부 모습입니다.
                            화이트와 블랙의 대비감을 이용해 더 널어 보이게 연출했습니다.</p>
                    </div>
                    <div id="model_dental_X-ray_room">
                        <div class="mb-5"><img src="${pageContext.request.contextPath}/resources/model_dental_images/photos/black_4.PNG" style="width: 80%;"/></div>
                    ...
                    <div id="model_dental_makeup_corner">
                        <div class="mb-5"><img src="${pageContext.request.contextPath}/resources/model_dental_images/photos/black_5.PNG" style="width: 80%;"/></div>
                        <p>[특진실]</p>
                    ...
                    <div id="model_dental_doctor_room">
                        <div class="mb-5"><img src="${pageContext.request.contextPath}/resources/model_dental_images/photos/black_7.PNG" style="width: 80%;"/></div>
                        <p>[상담실]</p>
                        <p class="mb-5" style="width: 80%; margin: 0 auto;">상담실입니다.
