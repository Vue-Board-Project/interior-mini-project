...
<div id="model_dental_wrap" class="d-flex flex-column" style="background-color: #faf9f6; height: 260rem; font-family: 'MinSans-Regular';">
        ...
        <div id="model_dental_summary" style="background-color: #d5d5d8; margin: 3rem auto; border-radius: 50px;">
            <div class="d-flex justify-content-center pt-4 mr-5 ml-5" style="color: #272723;">
                ...
                <div class="mr-5"><img src="${pageContext.request.contextPath}/resources/model_dental_images/icons/premium-icon-house-design-3769340.png" style="height: 45px;"/><strong class="ml-3">50평</strong></div>
        ...
        <div id="model_dental_content" class="text-center">
            <div id="model_dental_waiting_room">
                ...
                <div class="mb-5"><img src="${pageContext.request.contextPath}/resources/model_dental_images/photos/3.PNG" style="width: 60%;"/></div>
                <div class="mb-5"><img src="${pageContext.request.contextPath}/resources/model_dental_images/photos/4.PNG" style="width: 60%;"/></div>
                <p class="mb-5">[대기실]</p>
                <p class="mb-5" style="width: 60%; margin: 0 auto;">외부에서 봤을 때 적당한 크기처럼 보이는 이 치과는 내부로 들어오면서 아주 넓은 구조를 가지고 있으며
            ...
            <div id="model_dental_treatment_room">
                <div>
                    ...
                    <div class="mb-5"><img src="${pageContext.request.contextPath}/resources/model_dental_images/photos/6.PNG" style="width: 60%;"/></div>
                </div>
                <p class="mb-5">[진료실]</p>
                <p class="mb-5" style="width: 60%; margin: 0 auto;">고객들이 편안하게 진료를 볼 수 있도록 프라이버시에도 많은 신경을 쓰면서
