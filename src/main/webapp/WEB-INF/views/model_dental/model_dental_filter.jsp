...
<link href="${pageContext.request.contextPath}/resources/css/model_dental/cssModelDentalFilter.css" rel="stylesheet" type="text/css">
<div id="dental_model_filter_group" class="m-3 text-left">
            <div class="dropdown">
              <button class="dropbtn"><span class="mr-2 dropbtn_text">정렬</span><img class="dropbtn_img" src="${pageContext.request.contextPath}/resources/model_dental_images/icons/dental_model_detail_dropdown_icon.png" style="width: 12px;"/></button>
            ...
            <div class="dropdown">
                <button class="dropbtn"><span class="mr-2 dropbtn_text">스타일</span><img class="dropbtn_img" src="${pageContext.request.contextPath}/resources/model_dental_images/icons/dental_model_detail_dropdown_icon.png" style="width: 12px;"/></button>
                <div class="dropdown-content">
              ...
              <div class="dropdown">
                <button class="dropbtn"><span class="mr-2 dropbtn_text">컬러</span><img class="dropbtn_img" src="${pageContext.request.contextPath}/resources/model_dental_images/icons/dental_model_detail_dropdown_icon.png" style="width: 12px;"/></button>
                <div class="dropdown-content">
              ...
              <div class="dropdown">
                <button class="dropbtn"><span class="mr-2 dropbtn_text">분야</span><img class="dropbtn_img" src="${pageContext.request.contextPath}/resources/model_dental_images/icons/dental_model_detail_dropdown_icon.png" style="width: 12px;"/></button>
                <div class="dropdown-content">
                  <div class="p-2 d-flex flex-column">
			            <label class="dental_model_field_choice">
