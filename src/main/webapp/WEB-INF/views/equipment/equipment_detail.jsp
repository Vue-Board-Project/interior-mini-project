...
<div id="k5chair_content"><!-- 대표 이미지 설정-->
    ...
    <div id="k5chair_main_right">
        <div>
            <p id="k5chair_main_content1">${detailProduct.productName} <img id="icon_dentist" src="${pageContext.request.contextPath}/resources/subinimage/doctor.png"/></P>
            <hr/>
            <p id="k5chair_main_content2">${detailProduct.productIntro}<br/>
