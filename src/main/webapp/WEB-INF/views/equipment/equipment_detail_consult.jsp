...
<section class=" p-0">
	...
	<div style="width: 65%;position: relative; left:10px; top: -33px;" class="mx-auto menuheadertitle">
		<span style="font-size: 50px; font-family: 'MinSans-Bold'; border-bottom: 5px solid coral; letter-spacing: 1.4px;">${detailProduct.productName}</span>
	</div>
</section>
		...
		<div id="eq_detail_c_main_right">
			<a id="go_productlist" class="btn btn-outline-dark" href="/springframework-mini-project/equipment/dental_equipment_main">목록으로</a>
				<div>
					...
					<div id="colorcheck">
						<form>
							<label for="default1">검정 </label> <input name="default1"
								type="radio" checked id="colorcheck_black"> <label
								for="default2">파랑 </label> <input name="default1" type="radio"
								id="colorcheck_blue"> <label for="default3">빨강 </label> <input
								name="default1" type="radio" id="colorcheck_red"> <label
								for="default4">보라 </label> <input name="default1" type="radio"
								id="colorcheck_purple"> <label for="default5">초록
							</label> <input name="default1" type="radio" id="colorcheck_green">
						</form>
					</div>
