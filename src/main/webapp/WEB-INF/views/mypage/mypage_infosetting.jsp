...
<div class = "container-fluid p-0">
	<div style = "display:flex; width : 100%; height: 1400px;">
		...
		<div class= "mypage_menu"  style = "display : inline-block;  width : 15%; height : 1600px; background-color : #faf9f6; border-right : 1px solid #ccc;">
		...
		<div class= "mypage_content" style = "display : inline-block; width : 85%; height : 1600px;  background-color : #faf9f6;">
			<div style = "display :inline-block; width : 100%; height : 300px;">
				<div style = "width : 90%; height : 160px; border-bottom : 1px solid #ccc; margin : auto;">
					<div style = "font-family: 'MinSans-Bold'; font-size : 3rem; margin-top : 140px; margin-left : 2%;">
						<span class ="pb-1" style ="border-bottom : 5px solid #ca5c0d;">개인정보 수정</span>
					</div>
				</div>
			</div>
			<div style = "display :inline-block; width : 100%; height : 1100px;">
					              ...
					              <form method="post" action="mypage_infosetting" id="content" style="display : inline-block; position : absolute; transform: translateX(50%); left : 20%; width: 700px;">
					                  ...
					                  <!-- 주소 입력 -->
					                   ...
					                   <div style = "display: flex; flex-direction: row;">
					                        ...
					                        <small style=" font-family: 'MinSans-Medium'; color: #ca5c0d; margin-left : 30px; margin-top : 18px;">주소가 없을 경우 인테리어, 리모델링 상담이 불가합니다.</small>
					                    </div>
