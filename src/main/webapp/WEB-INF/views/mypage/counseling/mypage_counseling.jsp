...
<div class = "container-fluid p-0">
	<div style = "display:flex; width : 100%; height: 1000px;">
		...
		<div class= "counseling_menu"  style = "display : inline-block;  width : 15%; height : 1000px; background-color : #faf9f6; border-right : 1px solid #ccc;">
		...
		<div class= "counseilng_content" style = "display : inline-block; width : 85%; height : 1000px;  background-color : #faf9f6;">
			<div style = "display :inline-block; width : 100%; height : 300px;">
...
<style>
    ...
    #mypage_counseling_jsp .mypage_counseling_display .counseling_section{
     ...
     /*견적신청 내용 버튼*/
  .counseilng_content .info_button{
