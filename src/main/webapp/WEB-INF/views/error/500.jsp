...
<main style="background-color: white">
    <div>
        <section class="consult_result_section" style="padding: 200px 0 10px 0;">
            <img src="${pageContext.request.contextPath}/resources/images/errorImages/500.jpg" width="300px">
        </section>
        <section class="consult_result_section" style="padding: 20px 0 10px 0;">
            <p style="font-family: 'MinSans-Bold'; font-size: 33px; font-weight: bold;">일시적 서버 오류 입니다.</p>
            <p style="font-family: 'MinSans-Regular'; letter-spacing: 1px; font-size: 18px;">어떤 이유로 서버에서 처리하지 못하였습니다. 잠시 후 다시 시도해주세요.<br/>
